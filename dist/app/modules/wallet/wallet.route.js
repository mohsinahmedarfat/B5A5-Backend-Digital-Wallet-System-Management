...
router.patch("/top-up/user/:userEmail", (0, checkAuth_1.default)(...Object.values(user_interface_1.Role)), wallet_controller_1.WalletController.topUpUserWallet);
router.patch("/top-up/agent/:agentEmail", (0, checkAuth_1.default)(...Object.values(user_interface_1.Role)), wallet_controller_1.WalletController.topUpAgentWallet);
